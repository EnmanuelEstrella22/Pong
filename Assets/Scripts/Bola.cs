...
public class Bola : MonoBehaviour
{
    ...
    //Clips de audio
    public AudioClip audioGol, audioRaqueta, audioRebote, audioGanador;
    //Contadores de goles
    ...
    public void reiniciarBola(string direccion)
    {
        ...
        if (direccion == "Derecha")
        {
            ...
            if(golesDerecha == 5)
            {
                ...
                finJuego();
                finalText.text = "Ganador: Jugador Izquierda";
            }
            else
            {
        ...
        else if (direccion == "Izquierda")
        {
            ...
            {
                finJuego();
                finalText.text = "Ganador: Jugador Derecha";
            }
            else
            {
                fuenteDeAudio.clip = audioGol;
    ...
    void Update()
    {
        ...
        velocidad = 30 + golesDerecha + golesIzquierda;
    }
}